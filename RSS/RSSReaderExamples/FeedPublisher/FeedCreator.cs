...
namespace RSSProducer
{
    public class FeedCreator
    {
        public static MemoryStream CreateFeed()
        {
            ...
            feed.Authors.Add(new SyndicationPerson("info@improveandrepeat.com", "Johnny Graber", "https://improveandrepeat.com/"));
            ...
            SyndicationItem item1 = new SyndicationItem(
                ...
                "ItemOneID",
                DateTimeOffset.Now);
            item1.PublishDate = DateTimeOffset.Now.AddDays(-3);
            ...
            SyndicationItem item2 = new SyndicationItem(
                ...
                "ItemTwoID",
                DateTimeOffset.Now);
            item2.PublishDate = DateTimeOffset.Now.AddDays(-2);
